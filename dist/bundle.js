(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["shadowengine"] = factory();
	else
		root["shadowengine"] = factory();
})(this, function() {
...
var _currentLevel = LEVELS.length;

var _log = function _log(type, source, args) {
  var position = LEVELS.indexOf(type);

  if (position === -1) throw new Error("invalid logging level");

  if (position > _currentLevel) return false;
...
var Logger = function () {
  ...
  (0, _createClass3.default)(Logger, null, [{
    ...
    value: function setLevel(level) {
      var position = LEVELS.indexOf(level);
...
var Scene = function () {
  function Scene(sceneHandler) {
    (0, _classCallCheck3.default)(this, Scene);
    this._sceneHandler = null;
    this.entities = [];
  ...
  (0, _createClass3.default)(Scene, [{
    ...
    key: "getSceneHandler",
    value: function getSceneHandler() {
...
var Context2D = function () {
		function Context2D(context) {
				(0, _classCallCheck3.default)(this, Context2D);
				this._context = null;

				this._context = context;
		}

		(0, _createClass3.default)(Context2D, [{
				key: "getContext",
...
var Entity = function () {
  function Entity(scene) {
    ...
    this._position = _Vector2.default.Invalid();
    this._scene = null;
  ...
  (0, _createClass3.default)(Entity, [{
    ...
    key: "draw",
    value: function draw(ctx, screenPosition) {}
  }, {
    key: "update",
    value: function update(delta) {}
  }]);
...
var _mouseLetGo = false;

var _normalizeEvent = function _normalizeEvent(event) {
  var x = -1,
      y = -1;
...
$(window).bind("touchstart mouseup", function (event) {
  return _mouseLetGo = true;
});
$(window).bind("touchstop mousedown", function (event) {
  return _IsDown = true;
});
...
var Mouse = function () {
  ...
  (0, _createClass3.default)(Mouse, null, [{
    key: "update",
    ...
    key: "IsInsideBBox",
    value: function IsInsideBBox(x, y, width, height) {
      return Mouse.X >= x && Mouse.X <= x + width && Mouse.Y >= y && Mouse.Y <= y + height;
    }
  }, {
    key: "IsInsideBCircle",
    value: function IsInsideBCircle(x, y, radius) {
      var dx = Math.abs(Mouse.X - x);
      var dy = Math.abs(Mouse.Y - y);
    ...
    key: "IsAtRightEdge",
    get: function get() {
      return _X <= $(window).width() - 10;
    }
  }, {
    key: "IsAtBottomEdge",
    get: function get() {
      return _Y <= $(window).height() - 10;
    }
  }]);
  return Mouse;
}();
...
var SceneHandler = function () {
  function SceneHandler(game) {
    (0, _classCallCheck3.default)(this, SceneHandler);
    this._game = null;
    this._currentScene = null;

    _Logger2.default.debug("SceneHandler", "initializing scene handler...");
    this._game = game;
  }

  (0, _createClass3.default)(SceneHandler, [{
    key: "getGame",
    value: function getGame() {
      return this._game;
    }
    ...
    key: "switchScene",
    value: function switchScene(SceneClass) {
      var args = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

      if (this._currentScene !== null) this._currentScene.destroy();

      var instance = new SceneClass(this, args);
      this._currentScene = instance;
    }
  }, {
    key: "update",
    value: function update(delta) {
      if (this._currentScene !== null) this._currentScene.update(delta);
    }
  }]);
  return SceneHandler;
}();
...
var Vector2 = function () {
	...
	(0, _createClass3.default)(Vector2, [{
		...
		key: "distanceTo",
		value: function distanceTo(vector2) {
			var a = this.X - vector2.X;
			var b = this.Y - vector2.Y;
...
var Vector3 = function () {
	(0, _createClass3.default)(Vector3, null, [{
		key: "Random",
		value: function Random(min, max) {
			return new Vector2(Math.random() * (max.X - min.X) + min.X, Math.random() * (max.Y - min.Y) + min.Y, Math.random() * (max.Z - min.Z) + min.Z);
		}
	}, {
		key: "Invalid",
		value: function Invalid() {
	...
	function Vector3(x, y, z) {
		var valid = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
	...
	(0, _createClass3.default)(Vector3, [{
		...
		key: "distanceTo",
		value: function distanceTo(vector3) {
			// @todo
			return 0;
		}
	}]);
...
var Color = function () {
	(0, _createClass3.default)(Color, null, [{
		...
		value: function Random() {
			...
			return new Color(Math.random() * 255 | 0, Math.random() * 255 | 0, Math.random() * 255 | 0, alpha == null ? Math.random() : alpha);
		}
	}, {
		key: "Invalid",
		value: function Invalid() {
	...
	function Color(r, g, b) {
		...
		var valid = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
	...
	(0, _createClass3.default)(Color, [{
		...
		key: "asRGBA",
		value: function asRGBA() {
			return "rgba(" + this.R + ", " + this.G + ", " + this.B + ", " + this.A + ")";
		}
	}, {
		key: "asHex",
		value: function asHex() {
			var rgba = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

			var a = ("0" + (this.A * 255).toString(16)).slice(-2);
...
var Engine = function () {
  function Engine(GameClass, RendererClass) {
    (0, _classCallCheck3.default)(this, Engine);
    this._game = null;
    this._renderer = null;

    _Logger2.default.info("Engine", "initializing engine...");
...
var _SceneHandler = __webpack_require__(40);
...
var Game = function () {
  function Game(engine) {
    ...
    this._frameMeter = null;
    this._updateRate = 1000 / 30;

    _Logger2.default.debug("Game", "initializing game...");

    this._engine = engine;
    this._sceneHandler = new _SceneHandler2.default(this);

    this._createMeters();
    $(window).focus(function () {
      _this._lastGlobalTime = performance.now();
      _this._lastFrameTime = performance.now();
      _this._lastUpdateTime = performance.now();
    });
  }
  ...
  (0, _createClass3.default)(Game, [{
    ...
    value: function start() {
      ...
      var loop = function loop() {
        if (_this2._stopped) return;

        var delta = _this2._getGlobalDelta();
        _this2._accumulator += delta;

        var stepsCount = 0;
        while (_this2._accumulator >= _this2._updateRate) {
          _this2.update(_this2._updateRate);
          _this2._accumulator -= _this2._updateRate;

          if (++stepsCount >= 240) {
            _Logger2.default.error("performance is unacceptable. step count: ", stepsCount);
            delta = 0;
            break;
          }
        }
    ...
    value: function update() {
      ...
      var delta = this._getUpdateDelta();
      this.getSceneHandler().update(delta);
      _Mouse2.default.update();
    ...
    key: "_getGlobalDelta",
    value: function _getGlobalDelta() {
      var now = performance.now();
      var delta = now - this._lastGlobalTime;
      this._lastGlobalTime = now;
      return delta;
    }
  }, {
    key: "_getFrameDelta",
    value: function _getFrameDelta() {
      var now = performance.now();
    ...
    key: "_getUpdateDelta",
    value: function _getUpdateDelta() {
      var now = performance.now();
...
var _Vector = __webpack_require__(41);

var _Vector2 = _interopRequireDefault(_Vector);

var _Context2D = __webpack_require__(37);
...
var Canvas2D = function (_Renderer) {
  (0, _inherits3.default)(Canvas2D, _Renderer);

  function Canvas2D() {
    (0, _classCallCheck3.default)(this, Canvas2D);

    var _this = (0, _possibleConstructorReturn3.default)(this, (Canvas2D.__proto__ || (0, _getPrototypeOf2.default)(Canvas2D)).call(this));

    _this._$canvas = null;
    _this._context = null;
    _this._size = _Vector2.default.Invalid();


    _this._$canvas = $('<canvas></canvas>');
    _this._context = _this._$canvas.get(0).getContext('2d');
    _this._drawing = new _Context2D2.default(_this._context);

    $('body').append(_this._$canvas);
  ...
  (0, _createClass3.default)(Canvas2D, [{
    key: "getSize",
...
var Canvas3D = function (_Renderer) {
  (0, _inherits3.default)(Canvas3D, _Renderer);

  function Canvas3D() {
    (0, _classCallCheck3.default)(this, Canvas3D);
    return (0, _possibleConstructorReturn3.default)(this, (Canvas3D.__proto__ || (0, _getPrototypeOf2.default)(Canvas3D)).apply(this, arguments));
  }
...
var _Scene2 = __webpack_require__(21);

var _Scene3 = _interopRequireDefault(_Scene2);

var _Entity = __webpack_require__(38);

var _Entity2 = _interopRequireDefault(_Entity);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var GameRTS = function (_Scene) {
  (0, _inherits3.default)(GameRTS, _Scene);

  function GameRTS(sceneHandler) {
    (0, _classCallCheck3.default)(this, GameRTS);
    return (0, _possibleConstructorReturn3.default)(this, (GameRTS.__proto__ || (0, _getPrototypeOf2.default)(GameRTS)).call(this, sceneHandler));
  }

  return GameRTS;
}(_Scene3.default);

exports.default = GameRTS;
...
var Loading = function (_Scene) {
  (0, _inherits3.default)(Loading, _Scene);
...
exports.Scenes = exports.Renderers = exports.Input = exports.DrawingTools = exports.Components = exports.Vector3 = exports.Vector2 = exports.SceneHandler = exports.Scene = exports.Renderer = exports.Logger = exports.Game = exports.Entity = exports.Engine = exports.Component = exports.Color = undefined;
...
var _Engine = __webpack_require__(58);
...
var _Vector3 = __webpack_require__(42);
...
var _ASCII = __webpack_require__(60);

var _ASCII2 = _interopRequireDefault(_ASCII);

var _Canvas2D = __webpack_require__(61);

var _Canvas2D2 = _interopRequireDefault(_Canvas2D);

var _Canvas3D = __webpack_require__(62);
...
var _GameRTS = __webpack_require__(63);

var _GameRTS2 = _interopRequireDefault(_GameRTS);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Components = {};
var DrawingTools = { Context2D: _Context2D2.default };
var Input = { Mouse: _Mouse2.default };
var Renderers = { Canvas2D: _Canvas2D2.default, Canvas3D: _Canvas3D2.default, ASCII: _ASCII2.default };
var Scenes = { Loading: _Loading2.default, GameRTS: _GameRTS2.default };
...
exports.SceneHandler = _SceneHandler2.default;
exports.Vector2 = _Vector2.default;
exports.Vector3 = _Vector4.default;
...
// module
exports.push([module.i, "html,\nbody {\n  background: black;\n  width: 100%;\n  height: 100%;\n  margin: 0;\n  padding: 0;\n}\ncanvas {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n}\n.fps-meters {\n  zoom: 0.8;\n}\n.fps-meters > div:nth-child(2) > div:nth-child(3) > div {\n  background: #3f3f00 !important;\n}\n", ""]);
